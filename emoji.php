...
<head>
<meta charset="utf-8" />
<title>Emoji :: Anonymous ChatBox</title>
...
<div class="alert" style="background:#272b30;opacity:0.9;">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="list-group-item-heading text-center">Emoji</h3>
			  <p class="text-muted text-center">choose something you like from the sets of Emoji, and copy code in chat.</p>
            </div>
          </div>
